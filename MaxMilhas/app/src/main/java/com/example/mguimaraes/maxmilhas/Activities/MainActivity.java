...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new OutboundFragment(), getResources().getString(R.string.outbound_flights));
        adapter.addFragment(new InboundFragment(), getResources().getString(R.string.inbound_flights));
